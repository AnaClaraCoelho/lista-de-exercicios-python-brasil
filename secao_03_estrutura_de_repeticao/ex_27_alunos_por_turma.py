...
def calcular_media_de_alunos_por_turma():
    ...
    while count < turmas:
        ...
        if qtd_alunos > 40 or qtd_alunos < 1:
            print(f"Uma turma deve ter de 1 a 40 alunos, não é possível ter {qtd_alunos} alunos")
        else:
            sum += qtd_alunos
            count += 1
            pass

    print(f"Média de alunos por turma: {sum/turmas :.0f}")
